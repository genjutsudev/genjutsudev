...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('referrer_nid')->comment('referrer_user_id');
            $table->string('type')->comment('тип уч. записи');
            $table->tinyInteger('is_active')->default(true);
            $table->string('profilelink', 32);
            $table->string('email');
            ...
            $table->string('registration_country')->comment('географическое местоположение (страна/город)');
