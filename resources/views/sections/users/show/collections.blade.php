...
<x-layouts::users-show>
    <div class="row">
        <div class="col-3" style="width: 25.2%;">
            <div class="border-end h-100">
                <div class="list-group rounded-0">
                    @foreach([
                        ...
                        'on_hold' => ['title' => 'Отложено', 'textClass' => 'text-secondary', 'activeClass' => 'bd-secondary-lt', 'icon' => '<i class="fa fa-pause" aria-hidden="true"></i>'],
                        ...
                        <a href="/{{ $slug }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-start border-0 border-bottom ps-3">
                            <div class="me-auto">
